                    ...
                    <div class="col-12">
                      <div class="numbers">
                        ...
                        <h5 class="font-weight-bolder mb-0">
                          ...
                          <span class="text-success text-sm font-weight-bolder">{{number_format($totalToday)}}</span>
                        </h5>
                      </div>
                    </div>
              ...
              <div class="card">
                <div class="card-body p-3">
                  <div class="row">
                    <div class="col-8">
                      <div class="numbers">
                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Đơn huỷ</p>
                        <h5 class="font-weight-bolder mb-0">
                          62
              ...
              <div class="card">
                <div class="card-body p-3">
                  <div class="row">
                    <div class="col-8">
                      <div class="numbers">
                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Đơn trả hàng</p>
                        <h5 class="font-weight-bolder mb-0">
                          30
