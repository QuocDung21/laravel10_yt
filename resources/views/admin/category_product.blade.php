                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="/uploads/category/{{$cate_pro->category_img}}"
                                                         class="avatar avatar-sm me-3" alt="">
                                                </div>
{{--                                                <span>public/uploads/category/{{$cate_pro->category_img}}</span>--}}
                                        ...
                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ $cate_pro->created_at}}</span>
                                        </td>
                                        <td class="align-middle">
                                            ...
                                            <a href="{{ route('move-up-category', ['categoryId' => $cate_pro->category_id]) }}"
                                               class="btn btn-link text-danger text-gradient px-3 mb-0"
                                               title="Di chuyển vị trí lên">
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body p-3">
                        <form action="{{URL::to('/save-category-product')}}" method="post"
                            ...
                            <img id="previewImg" class="w-40 border-radius-lg shadow" src="" alt=""
                                 style="display: none">

                            <input type="submit" name="add_category" class="btn bg-gradient-info w-100 mt-4 mb-0"
                                   value="Thêm danh mục">
                        </form>
                        <script>
    ...
    {{-- <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" rDanh sách danh mụcole="document">
