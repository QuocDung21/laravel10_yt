<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse   w-auto " id="sidenav-collapse-main" style="display: block; overflow: auto;" >
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{URL::to('/category-product')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{URL::to('/order-list')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{URL::to('/prescription')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              ...
              <span class="nav-link-text ms-1">Toa thuốc</span>
            </a>
          </li>

        
        <li class="nav-item mt-3">
            <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Danh mục</h6>
        </li>
                ...
                <ul class="nav ms-4 ps-3">
                    <li class="nav-item ">
                        <a class="nav-link " href="{{URL::to('/add-product')}}">
                            ...
                            <span class="sidenav-normal"> Thêm sản phẩm mới </span>
                        </a>
                    </li>

                    <li class="nav-item ">
                        <a class="nav-link " href="{{URL::to('/product-list')}}">
        ...
        <li class="nav-item">
            <a class="nav-link  " href="{{URL::to('shipping-unit')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <li class="nav-item">
            <a class="nav-link  " href="{{URL::to('discount')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <li class="nav-item">
            <a data-bs-toggle="collapse" href="#applicationsExamples1" class="nav-link "
                aria-controls="applicationsExamples" role="button" aria-expanded="false">
                <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                    <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <div class="collapse " id="applicationsExamples1">
                <ul class="nav ms-4 ps-3">
                    <li class="nav-item ">
                        <a class="nav-link " href="{{URL::to('/advertising')}}">
                            
                            <span class="sidenav-normal"> Bìa quảng cáo </span>
                        </a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link " href="{{URL::to('/addcatepost')}}">
                            
                            <span class="sidenav-normal"> Danh mục bài viết </span>
                        </a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link " href="{{URL::to('/addpost')}}">
                            
                            <span class="sidenav-normal"> Thêm bài viết mới </span>
                        </a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link " href="{{URL::to('/listpost')}}">
                            
                            <span class="sidenav-normal"> Danh sách bài viết </span>
                        </a>
                    </li>
        ...
        <li class="nav-item">
            <a data-bs-toggle="collapse" href="#applicationsExamples2" class="nav-link "
                aria-controls="applicationsExamples" role="button" aria-expanded="false">
                <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                    <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <div class="collapse " id="applicationsExamples2">
                <ul class="nav ms-4 ps-3">
                    <li class="nav-item ">
                        <a class="nav-link " href="{{URL::to('/user-list')}}">
                            
                            <span class="sidenav-normal"> Danh sách khách hàng </span>
                        </a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link " href="{{URL::to('/send-email')}}">
                            
                            <span class="sidenav-normal"> Email nhận khuyến mãi </span>
                        </a>
                    </li>
      ...
      <script>
        $(document).ready(function() {
          ...
          // Duyệt qua tất cả các thẻ "a" trong "ul.navbar-nav"
          $('ul.navbar-nav li a').each(function() {
            // Nếu đường dẫn URL của thẻ "a" trùng khớp với đường dẫn URL hiện tại
            if ($(this).attr('href') === currentURL) {
              // Thêm class "active" vào thẻ "a" và "li" tương ứng
